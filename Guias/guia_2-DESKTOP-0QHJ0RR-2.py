...
def f2c (f: float) -> float:
    ...
    #Devuelve: la conversión de grados fahrenheit a grados celsius.
...
def cantidad_a (s: str, a: str) -> int:
    ...
    # Devuelve: la cantidad de veces que la letra a está dentro de s
    # Ejemplo: si s = calabaza -> 4
...
def cantidad_contenida (a: str, b: str) -> int:
    # Requiere: valor a y b strings.
    # Devuelve: la cantidad de veces que b está contenida en a
    # Ejemplo: si a = perro perro perro y b = perro -> 3
